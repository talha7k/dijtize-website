      ...
      <DialogContent className="modal sm:max-w-4xl max-h-[90vh] overflow-y-auto rounded-xl p-0 bg-transparent/55 backdrop-blur-sm">
        <div className="p-6 md:p-8">
          ...
          <div className="mt-6 flex flex-col sm:grid sm:grid-cols-[35%_65%] md:grid-cols-[35%_65%] gap-8">
            {/* Image Container */}
            <div className="relative h-[150px] sm:h-auto min-h-[100px] max-h-[150px] rounded-lg overflow-hidden flex items-center justify-center w-full sm:w-auto bg-gray-800">
              <Image
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {service.techStack.map((techUrl, index) => (
                    <span
                      key={index}
                      className="inline-flex items-center bg-gray-900 text-primary text-sm px-3 rounded-full h-8"
                    >
                      <Image
                        src={techUrl}
